...
/**
 * <p>
 * This class represents a polygon, defined by the array of the segment points
 * in {@code (x,y)} coordinate space with drag-able points. It wraps the
 * coordinates of {@link javafx.scene.shape.Polygon} to make them available as
 * attributes in FXML. That is made by {@link CustomPolygon#points}. The Polygon
 * class is similar to the Polyline class, except that the Polyline class is not
 * automatically closed.
 * </p>
 * 
 * <p>
 * FXML example usage. The following snippet creates a polygon made of four
 * points.
 * </p>
 *
 * <pre>
 * {@code
 * <?import it.univaq.disim.ermes.metaeditor.common.ente.customNode.CustomPolygon?>
 * 
 * <fx:root type="Ente" xmlns:fx="http://javafx.com/fxml/1">
 * <children>
 *    <CustomPolygon fx:id="customLine" points=
"0.0,0.0, 160.0,0.0, 160.0,80.0, 0.0,80.0" strokeWidth="1.0" stroke=
"rgb(255,192,0)"/>
 ...
 * 
 * <p>
 * <strong>NOTE: The id of CustomPolygon must be equal to {@code customLine} as
 * stated in {@link LineWrapper}</strong>
 * </p>
 *
 */
public class CustomPolygon extends LineWrapper {
	...
	public CustomPolygon() {
		...
		lineShape = new javafx.scene.shape.Polygon(0.0, 0.0, 150.0, 0.0, 75.0, 0.0);
		...
		points.addListener(new ListChangeListener<Double>() {
			...
			public void onChanged(javafx.collections.ListChangeListener.Change<? extends Double> c) {
				((javafx.scene.shape.Polygon) lineShape).getPoints().clear();
				((javafx.scene.shape.Polygon) lineShape).getPoints().addAll(points);
			}
	...
	// ================================================================================
	// Wrapper of Polygon coordinates - START
	// ================================================================================
	...
	// ================================================================================
	// Wrapper of Polygon coordinates - STOP
	// ================================================================================

	/**
	 * Implementation of {@link LineWrapper#getPointsCoords()}. It is exactly the
	 * same as {@link CustomPolygon#points}
	 */
	@Override
	public ObservableList<Double> getPointsCoords() {
		return ((javafx.scene.shape.Polygon) lineShape).getPoints();
	}
	...
	public void addModel(ElementPosition objModel) {
		...
		// model (the position changed event is managed by the databinding)
		this.model.eAdapters().add(new AdapterImpl() {
			...
			public void notifyChanged(Notification notification) {
				...
				if (notification.getEventType() == Notification.ADD
					...
					BendPoint new_bendPoint = new BendPoint(xProperty, yProperty, CustomPolygon.this);
					...
					CustomPolygon.this.getChildren().add(new_bendPoint);
				...
				if (notification.getEventType() == Notification.REMOVE
					...
					CustomPolygon.this.getChildren().remove(clicked_BendPoint);
