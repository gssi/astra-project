...
public class SchedulerSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case SchedulerPackage.SCHEDULER_MODEL: {
				SchedulerModel schedulerModel = (SchedulerModel)theEObject;
				T result = caseSchedulerModel(schedulerModel);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SchedulerPackage.TABLE_TASK: {
				TableTask tableTask = (TableTask)theEObject;
				T result = caseTableTask(tableTask);
				if (result == null) result = caseNamedElement(tableTask);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case SchedulerPackage.ACT: {
				ACT act = (ACT)theEObject;
				T result = caseACT(act);
				if (result == null) result = caseNamedElement(act);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SchedulerPackage.TICK: {
				Tick tick = (Tick)theEObject;
				T result = caseTick(tick);
				if (result == null) result = caseNamedElement(tick);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T caseSchedulerModel(SchedulerModel object) {
		return null;
	}
