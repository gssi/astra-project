...
public class SchedulerFactoryImpl extends EFactoryImpl implements SchedulerFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case SchedulerPackage.SCHEDULER_MODEL: return createSchedulerModel();
			case SchedulerPackage.TABLE_TASK: return createTableTask();
			case SchedulerPackage.TASK: return createTask();
			case SchedulerPackage.ACT: return createACT();
			case SchedulerPackage.TICK: return createTick();
			case SchedulerPackage.NAMED_ELEMENT: return createNamedElement();
			default:
	...
	public SchedulerModel createSchedulerModel() {
		SchedulerModelImpl schedulerModel = new SchedulerModelImpl();
